--------------------------------------------------------------------------------
-- $Header: /local/Projects/CVS/P1/zpu_SoC/sources/xilinx/XilinxCoreLib/fir_compiler_v3_1_comp.vhd,v 1.1 2010-07-10 21:43:10 mmartinez Exp $
--------------------------------------------------------------------------------
...
-- /___/  \  /   Vendor: Xilinx
-- \   \   \/    Version: 1.0
--  \   \        Filename: fir_compiler_v3_1_xst_comp.vhd
--  /   /        Date Last Modified: 
...
-- library fir_compiler_v3_1;
-- use fir_compiler_v3_1.mac_fir_utils_pkg.all;

package fir_compiler_v3_1_comp is

  -----------------------------------------------------------------------------
  component fir_compiler_v3_1
  generic (
  ...
  ATTRIBUTE box_type OF fir_compiler_v3_1 : COMPONENT IS "black_box"; 
  ATTRIBUTE GENERATOR_DEFAULT : STRING; 
  ATTRIBUTE GENERATOR_DEFAULT OF fir_compiler_v3_1 : COMPONENT IS 
            "generatecore com.xilinx.ip.fir_compiler_v3_1.fir_compiler_v3_1";


end fir_compiler_v3_1_comp;
