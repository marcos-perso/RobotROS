...
--
-- $Revision: 1.1 $ $Date: 2010-07-10 21:42:57 $
library ieee;
...
use XilinxCoreLib.c_sin_cos_v5_1_pack.all;
use XilinxCoreLib.pipe_bhv_v5_1_comp.all;

-- standard libraries declarations
library XILINXCORELIB;
use XILINXCORELIB.prims_constants_v7_0.all;

entity C_SIN_COS_V5_1 is
	generic(
...
architecture behavioral of C_SIN_COS_V5_1 is
	...
	for COS_PIPE_DELAY : PIPE_BHV_V5_1 use entity xilinxcorelib.PIPE_BHV_V5_1;
	...
	for SIN_PIPE_DELAY : PIPE_BHV_V5_1 use entity xilinxcorelib.PIPE_BHV_V5_1;
