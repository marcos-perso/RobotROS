...
--
-- $Revision: 1.1 $ $Date: 2010-07-10 21:42:56 $
library ieee;
...
use XilinxCoreLib.c_shift_fd_v6_0_comp.all;
use XilinxCoreLib.c_reg_fd_v6_0_comp.all;
use XilinxCoreLib.c_sin_cos_v4_2_pack.all;
use XilinxCoreLib.pipe_bhv_v4_2_comp.all;

-- standard libraries declarations
library XILINXCORELIB;
use XILINXCORELIB.prims_constants_v6_0.all;

entity C_SIN_COS_V4_2 is
	generic(
...
architecture behavioral of C_SIN_COS_V4_2 is
	...
	for CE_DELAY : C_SHIFT_FD_V6_0 use entity xilinxcorelib.C_SHIFT_FD_V6_0;
	for COS_PIPE_DELAY : PIPE_BHV_V4_2 use entity xilinxcorelib.PIPE_BHV_V4_2;
	for COS_REG_OUT : C_REG_FD_V6_0 use entity xilinxcorelib.C_REG_FD_V6_0;
	for RDY_DELAY : C_SHIFT_FD_V6_0 use entity xilinxcorelib.C_SHIFT_FD_V6_0;
	for SIN_PIPE_DELAY : PIPE_BHV_V4_2 use entity xilinxcorelib.PIPE_BHV_V4_2;
	for SIN_REG_OUT : C_REG_FD_V6_0 use entity xilinxcorelib.C_REG_FD_V6_0;
