-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/Attic/x_sff.vhd,v 1.13 2006/12/01 22:58:11 yanx Exp $
-------------------------------------------------------------------------------
  ...
  begin
    if (TimingChecksOn) then
      VitalSetupHoldCheck (
        ...
        CheckEnabled   => TO_X01(((not RST_dly)) and (CE_dly) and ((not SET_dly)) and ((not SRST_dly)) and ((not SSET_dly))) /= '0',
        RefTransition  => 'R',
        HeaderMsg      => "/X_SFF",
        Xon            => XON,
        MsgOn          => MSGON,
      ...
      VitalSetupHoldCheck (
        ...
        CheckEnabled   => TO_X01(((not SET_dly)) and ((not RST_dly)) and ((not SRST_dly))) /= '0',
        RefTransition  => 'R',
        HeaderMsg      => "/X_SFF",
        Xon            => XON,
        MsgOn          => MSGON,
      ...
      VitalRecoveryRemovalCheck (
        ...
        ActiveLow      => false,
        CheckEnabled   => TO_X01(CE_dly) /= '0' and (I_dly /= '0' or O_zd /= '0' ),
        RefTransition  => 'R',
        HeaderMsg      => "/X_SFF",
        Xon            => XON,
        MsgOn          => MSGON,
      ...
      VitalRecoveryRemovalCheck (
        ...
        ActiveLow      => false,
        CheckEnabled   => TO_X01(((not RST_dly)) and (CE_dly)) /= '0' and I_dly /= '1' and O_zd /= '1',
        RefTransition  => 'R',
        HeaderMsg      => "/X_SFF",
        Xon            => XON,
        MsgOn          => MSGON,
      ...
      VitalSetupHoldCheck (
        ...
        CheckEnabled   => TO_X01(((not RST_dly)) and ((O_zd) xor (I_dly)) and ((not SET_dly)) and ((not SRST_dly)) and ((not SSET_dly))) /= '0',
        RefTransition  => 'R',
        HeaderMsg      => "/X_SFF",
        Xon            => XON,
        MsgOn          => MSGON,
