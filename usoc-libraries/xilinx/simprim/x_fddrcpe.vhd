-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/Attic/x_fddrcpe.vhd,v 1.9 2005/03/14 23:17:59 sranade Exp $
-------------------------------------------------------------------------------
...
-- attribute VITAL_LEVEL1 of X_FDDRCPE_V : architecture is TRUE;
  ...
  signal GSR_C0_dly : std_ulogic := 'X';
  signal GSR_C1_dly : std_ulogic := 'X';
...
begin
  ...
  begin
    ...
    VitalSignalDelay (GSR_C0_dly, GSR_ipd, tisd_GSR_C0);
    VitalSignalDelay (GSR_C1_dly, GSR_ipd, tisd_GSR_C1);
  ...
  begin
    ...
    if (TimingChecksOn) then
      ...
      VitalRecoveryRemovalCheck (
        ...
        TestSignalName => "C0",
        TestDelay => ticd_C0,
        RefSignal => GSR_C0_dly,
        RefSignalName => "GSR",
        RefDelay => tisd_GSR_C0,
      ...
      VitalRecoveryRemovalCheck (
        ...
        TestSignalName => "C1",
        TestDelay => ticd_C1,
        RefSignal => GSR_C1_dly,
        RefSignalName => "GSR",
        RefDelay => tisd_GSR_C1,
    ...
    VitalPathDelay01 (
      ...
      Paths => (0 => (C0_dly'last_event, tpd_C0_Q, true),
                ...
                3 => (GSR_ipd'last_event, tpd_GSR_Q, true),
                4 => (PRE_ipd'last_event, tpd_PRE_Q, true)),
