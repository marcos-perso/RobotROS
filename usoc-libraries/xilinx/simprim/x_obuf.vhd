-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/Attic/x_obuf.vhd,v 1.6 2007/07/02 22:41:57 fphillip Exp $
-------------------------------------------------------------------------------
...
begin
  ...
  begin
    ...
    VitalPathDelay01Z (
      ...
      OutSignalName => "O",
      OutTemp       => O_zd,
      Paths         => (0 => (GTS_resolved'last_event, tpd_GTS_O, true),
