-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/Attic/x_fddrrse.vhd,v 1.9 2005/03/14 23:17:59 sranade Exp $
-------------------------------------------------------------------------------
  ...
  begin
    ...
    VitalPathDelay01 (
      ...
      Paths => (0 => (C0_dly'last_event, tpd_C0_Q, true),
                ...
                2 => (GSR_ipd'last_event, tpd_GSR_Q, true)),
      Mode => VitalTransport,
      Xon => Xon,
      MsgOn => MsgOn,
      MsgSeverity => warning);
