-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/Attic/x_obufds.vhd,v 1.12 2007/07/02 22:41:57 fphillip Exp $
-------------------------------------------------------------------------------
  ...
  begin
    ...
    VitalPathDelay01Z (
      ...
      Paths         => (0 => (I_ipd'last_event, VitalExtendToFillDelay(tpd_I_O), (GTS_resolved = '0')),
                        1 => (GTS_resolved'last_event, tpd_GTS_O, true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning,
    ...
    VitalPathDelay01Z (
      ...
      Paths         => (0 => (I_ipd'last_event, VitalExtendToFillDelay(tpd_I_OB), (GTS_resolved = '0')),
                        1 => (GTS_resolved'last_event, tpd_GTS_OB, true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning,
