-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/rainier/VITAL/Attic/x_afifo36_internal.vhd,v 1.16.6.1 2008/04/28 22:33:55 wloo Exp $
-------------------------------------------------------------------------------
...
-- Added ren_var/wren_var to remember the old val of RDEN_dly/WREN_dly
  ...
  prcs_x_1_output: process (WRCOUNT_zd, RDCOUNT_zd, DO_OUT_MUX_zd, DOP_OUT_MUX_zd, RST_dly, GSR_dly, rst_rdclk_flag, rst_wrclk_flag)
