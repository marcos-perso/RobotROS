-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/Attic/x_ramb16_s18.vhd,v 1.12 2007/07/13 20:37:50 wloo Exp $
-------------------------------------------------------------------------------
...
--  \   \         Description : Xilinx Timing Simulation Library Component
--  /   /                  16K-Bit Data and 2K-Bit Parity Dual Port Block RAM
-- /___/   /\     Filename : X_RAMB16_S1_S4.vhd
-- \   \  /  \    Timestamp : Thu Apr  8 10:56:56 PDT 2004
--  \___\/\___\
--
-- Revision:
...
entity X_RAMB16_S1_S4 is
  ...
  attribute VITAL_LEVEL0 of
    X_RAMB16_S1_S4 : entity is true;
end x_ramb16_s1_s4;

architecture X_RAMB16_S1_S4_V of X_RAMB16_S1_S4 is

  attribute VITAL_LEVEL0 of
    X_RAMB16_S1_S4_V : architecture is true;
                  ...
                  if (wea_dly_sampled /= '0') then
                    ...
                    if ((collision_type = 1) or (collision_type = 3)) then
                      Memory_Collision_Msg
                        (collision_type => Write_A_Write_B,
                         EntityName => "X_RAMB16_S1_S4",
                         InstanceName => x_ramb16_s1_s4'path_name,
                         address_a => addra_dly_sampled,
                         address_b => addrb_dly_sampled
                         );
                    end if;
