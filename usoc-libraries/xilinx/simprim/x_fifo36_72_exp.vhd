-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/rainier/VITAL/Attic/x_fifo36_72_exp.vhd,v 1.10 2006/08/22 00:10:05 wloo Exp $
-------------------------------------------------------------------------------
...
--  Output-to-Clock path delay
    ...
    VitalPathDelay01 (
      ...
      Paths         => (0 => (WRCLKL_dly'last_event, tpd_WRCLKL_ECCPARITY(0), (GSR_dly /= '1' )),
                        1 => (GSR_dly'last_event, tpd_GSR_ECCPARITY(0), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (WRCLKL_dly'last_event, tpd_WRCLKL_ECCPARITY(1), (GSR_dly /= '1' )),
                        1 => (GSR_dly'last_event, tpd_GSR_ECCPARITY(1), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (WRCLKL_dly'last_event, tpd_WRCLKL_ECCPARITY(2), (GSR_dly /= '1' )),
                        1 => (GSR_dly'last_event, tpd_GSR_ECCPARITY(2), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (WRCLKL_dly'last_event, tpd_WRCLKL_ECCPARITY(3), (GSR_dly /= '1' )),
                        1 => (GSR_dly'last_event, tpd_GSR_ECCPARITY(3), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (WRCLKL_dly'last_event, tpd_WRCLKL_ECCPARITY(4), (GSR_dly /= '1' )),
                        1 => (GSR_dly'last_event, tpd_GSR_ECCPARITY(4), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (WRCLKL_dly'last_event, tpd_WRCLKL_ECCPARITY(5), (GSR_dly /= '1' )),
                        1 => (GSR_dly'last_event, tpd_GSR_ECCPARITY(5), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (WRCLKL_dly'last_event, tpd_WRCLKL_ECCPARITY(6), (GSR_dly /= '1' )),
                        1 => (GSR_dly'last_event, tpd_GSR_ECCPARITY(6), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (WRCLKL_dly'last_event, tpd_WRCLKL_ECCPARITY(7), (GSR_dly /= '1' )),
                        1 => (GSR_dly'last_event, tpd_GSR_ECCPARITY(7), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLKL_dly'last_event, tpd_RDCLKL_DBITERR, (GSR_dly /= '1' )),
                        1 => (GSR_dly'last_event, tpd_GSR_DBITERR, true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLKL_dly'last_event, tpd_RDCLKL_SBITERR, (GSR_dly /= '1' )),
                        1 => (GSR_dly'last_event, tpd_GSR_SBITERR, true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
