-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/rainier/VITAL/Attic/x_ramb18sdp.vhd,v 1.19 2007/08/17 21:39:10 wloo Exp $
-------------------------------------------------------------------------------
...
architecture X_RAMB18SDP_V of X_RAMB18SDP is
  ...
  signal GSR_RDCLK_dly : std_ulogic                          := 'X';
  ...
  signal GSR_WRCLK_dly : std_ulogic                          := 'X';
...
----- GSR
  ...
  begin
    ...
    VitalSignalDelay (GSR_RDCLK_dly, GSR_ipd, tisd_GSR_RDCLK);
    ...
    VitalSignalDelay (GSR_WRCLK_dly, GSR_ipd, tisd_GSR_WRCLK);
...
-------------------------------------------------------------------------------
  process
    ...
    variable Tviol_GSR_RDCLK_posedge     : std_ulogic := '0';
    ...
    variable Tviol_GSR_WRCLK_posedge     : std_ulogic := '0';
    ...
    variable Tmkr_GSR_RDCLK_posedge      : VitalTimingDataType := VitalTimingDataInit;
    ...
    variable Tmkr_GSR_WRCLK_posedge      : VitalTimingDataType := VitalTimingDataInit;
 ...
 begin
    ...
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(0), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(0), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(1), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(1), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(2), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(2), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(3), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(3), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(4), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(4), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(5), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(5), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(6), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(6), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(7), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(7), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(8), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(8), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(9), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(9), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(10), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(10), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(11), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(11), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(12), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(12), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(13), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(13), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(14), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(14), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(15), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(15), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(16), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(16), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(17), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(17), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(18), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(18), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(19), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(19), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(20), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(20), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(21), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(21), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(22), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(22), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(23), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(23), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(24), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(24), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(25), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(25), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(26), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(26), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(27), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(27), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(28), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(28), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(29), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(29), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(30), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(30), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DO(31), (rden_dly /= '0' and GSR_RDCLK_dly /= '1')),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DO(31), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DOP(0), (rden_dly /= '0' and GSR_RDCLK_dly /= '1' )),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DOP(0), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DOP(1), (rden_dly /= '0' and GSR_RDCLK_dly /= '1' )),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DOP(1), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DOP(2), (rden_dly /= '0' and GSR_RDCLK_dly /= '1' )),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DOP(2), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (RDCLK_dly'last_event, tpd_RDCLK_DOP(3), (rden_dly /= '0' and GSR_RDCLK_dly /= '1' )),
                        1 => (GSR_RDCLK_dly'last_event, tpd_GSR_DOP(3), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
