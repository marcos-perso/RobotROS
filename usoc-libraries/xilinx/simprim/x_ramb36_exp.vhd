-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/rainier/VITAL/Attic/x_ramb36_exp.vhd,v 1.18 2007/08/17 21:39:10 wloo Exp $
-------------------------------------------------------------------------------
...
-----  Port A
    ...
    VitalSignalDelay (GSR_CLKAL_dly, GSR_ipd, tisd_GSR_CLKAL);
    VitalSignalDelay (GSR_REGCLKAL_dly, GSR_ipd, tisd_GSR_REGCLKAL);
...
-----  Port B   
    ...
    VitalSignalDelay (GSR_CLKBL_dly, GSR_ipd, tisd_GSR_CLKBL);
    VitalSignalDelay (GSR_REGCLKBL_dly, GSR_ipd, tisd_GSR_REGCLKBL);
...
-------------------------------------------------------------------------------
  process
    ...
    variable Tviol_GSR_CLKAL_posedge     : std_ulogic := '0';
    ...
    variable Tviol_GSR_CLKBL_posedge     : std_ulogic := '0';
    ...
    variable Tmkr_GSR_CLKAL_posedge      : VitalTimingDataType := VitalTimingDataInit;
    ...
    variable Tmkr_GSR_CLKBL_posedge      : VitalTimingDataType := VitalTimingDataInit;
   ...
   begin
    ...
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_CASCADEOUTLATA, (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_CASCADEOUTLATA, true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (REGCLKAL_dly'last_event, tpd_REGCLKAL_CASCADEOUTREGA, (enal_dly /= '0' and GSR_REGCLKAL_dly /= '1')),
                        1 => (GSR_REGCLKAL_dly'last_event, tpd_GSR_CASCADEOUTREGA, true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(0), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(0), true),
                        2 => (CASCADEINLATA_dly'last_event, tpd_CASCADEINLATA_DOA(0), (RAM_EXTENSION_A /= "NONE")),
                        3 => (CASCADEINREGA_dly'last_event, tpd_CASCADEINREGA_DOA(0), (RAM_EXTENSION_A /= "NONE"))),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(1), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(1), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(2), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(2), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(3), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(3), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(4), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(4), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(5), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(5), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(6), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(6), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(7), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(7), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(8), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(8), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(9), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(9), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(10), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(10), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(11), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(11), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(12), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(12), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(13), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(13), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(14), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(14), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(15), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(15), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(16), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(16), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(17), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(17), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(18), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(18), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(19), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(19), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(20), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(20), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(21), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(21), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(22), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(22), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(23), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(23), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(24), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(24), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(25), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(25), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(26), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(26), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(27), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(27), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(28), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(28), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(29), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(29), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(30), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(30), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOA(31), (enal_dly /= '0' and GSR_CLKAL_dly /= '1')),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOA(31), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOPA(0), (enal_dly /= '0' and GSR_CLKAL_dly /= '1' )),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOPA(0), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOPA(1), (enal_dly /= '0' and GSR_CLKAL_dly /= '1' )),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOPA(1), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOPA(2), (enal_dly /= '0' and GSR_CLKAL_dly /= '1' )),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOPA(2), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKAL_dly'last_event, tpd_CLKAL_DOPA(3), (enal_dly /= '0' and GSR_CLKAL_dly /= '1' )),
                        1 => (GSR_CLKAL_dly'last_event, tpd_GSR_DOPA(3), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
...
----- Port B
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_CASCADEOUTLATB, (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_CASCADEOUTLATB, true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (REGCLKBL_dly'last_event, tpd_REGCLKBL_CASCADEOUTREGB, (enbl_dly /= '0' and GSR_REGCLKBL_dly /= '1')),
                        1 => (GSR_REGCLKBL_dly'last_event, tpd_GSR_CASCADEOUTREGB, true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(0), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(0), true),
                        2 => (CASCADEINLATB_dly'last_event, tpd_CASCADEINLATB_DOB(0), (RAM_EXTENSION_B /= "NONE")),
                        3 => (CASCADEINREGB_dly'last_event, tpd_CASCADEINREGB_DOB(0), (RAM_EXTENSION_B /= "NONE"))),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(1), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(1), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(2), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(2), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(3), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(3), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(4), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(4), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(5), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(5), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(6), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(6), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(7), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(7), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(8), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(8), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(9), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(9), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(10), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(10), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(11), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(11), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(12), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(12), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(13), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(13), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(14), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(14), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(15), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(15), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(16), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(16), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(17), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(17), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(18), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(18), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(19), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(19), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(20), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(20), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(21), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(21), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(22), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(22), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(23), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(23), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(24), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(24), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(25), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(25), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(26), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(26), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(27), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(27), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(28), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(28), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(29), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(29), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(30), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(30), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLKBL_dly'last_event, tpd_CLKBL_DOB(31), (enbl_dly /= '0' and GSR_CLKBL_dly /= '1')),
                        1 => (GSR_CLKBL_dly'last_event, tpd_GSR_DOB(31), true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
