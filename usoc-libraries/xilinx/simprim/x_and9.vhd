-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/Attic/x_and9.vhd,v 1.7 2005/02/22 06:54:42 fphillip Exp $
-------------------------------------------------------------------------------
...
entity X_AND9 is
  ...
  attribute VITAL_LEVEL0 of
    X_AND9 :     entity is true;
end X_AND9;

architecture X_AND9_V of X_AND9 is
  attribute VITAL_LEVEL1 of
    X_AND9_V : architecture is true;
...
begin
  ...
  begin
    O_zd := (I8_ipd) and (I7_ipd) and (I6_ipd) and (I5_ipd) and (I4_ipd) and (I3_ipd) and (I2_ipd) and (I1_ipd) and (I0_ipd);
    VitalPathDelay01 (
      OutSignal     => O,
