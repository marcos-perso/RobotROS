-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/Attic/x_latche.vhd,v 1.13 2006/09/12 18:12:19 yanx Exp $
-------------------------------------------------------------------------------
  ...
  begin
    ...
    VitalPathDelay01 (
      ...
      Paths         => (0 => (I_dly'last_event, tpd_I_O, (CLK_dly /= '0' and GE_dly /= '0' and RST_dly /= '1' and SET_dly /= '1') and (GSR_resolved = '0' and PRLD_resolved = '0') ),
                        ...
                        5   => (GSR_resolved'last_event, tpd_GSR_O, true),
                        6   => (PRLD_resolved'last_event, tpd_PRLD_O, true)),
      Mode          => VitalTransport,
      Xon           => XON,
      MsgOn         => MSGON,
      MsgSeverity   => warning);
