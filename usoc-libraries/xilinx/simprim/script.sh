...
#
cd ./ghdl/simprim
cp ./vhdl/src/simprims/simprim_Vcomponents.vhd .
cp ./vhdl/src/simprims/simprim_Vpackage.vhd .
#
...
cd  primitive
#
if [ -d ./vhdl/src/simprims/primitive ]
then
  cp -p ./vhdl/src/simprims/primitive/other/*.vhd .
  cp -p ./vhdl/src/simprims/primitive/other/vhdl_analyze_order .
else
  ./xilinx_vhdl_chop ./simprim_VITAL.vhd
