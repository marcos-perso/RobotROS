-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/Attic/x_latch_cpld.vhd,v 1.1 2006/08/09 22:29:50 yanx Exp $
-------------------------------------------------------------------------------
...
entity X_LATCH_CPLD is
  ...
  attribute VITAL_LEVEL0 of
    X_LATCH_CPLD : entity is true;
end X_LATCH_CPLD;

architecture X_LATCH_CPLD_V of X_LATCH_CPLD is
--  attribute VITAL_LEVEL1 of
--    X_LATCH_CPLD_V : architecture is true;
  ...
  begin
    ...
    VitalPathDelay01 (
      ...
      Paths                     => (0 => (I_dly'last_event, tpd_I_O, (CLK_dly /= '0' and RST_dly /= '1' and SET_dly /= '1' and GSR_resolved = '0' and PRLD_resolved = '0')),
                                    ...
                                    4 => (GSR_resolved'last_event, tpd_GSR_O, true),
                                    5 => (PRLD_resolved'last_event, tpd_PRLD_O, true)),
